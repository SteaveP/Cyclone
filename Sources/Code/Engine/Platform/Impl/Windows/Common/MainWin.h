    ...
    _In_ int       nCmdShow)
{
    ...
    CPlatformDataWin Data { hInstance, nCmdShow };

    // MAIN_CALLBACK should be included before including this file in the caller
    int result = Cyclone::PlatformIndependentMain(Argc, Argv, &Data, MAIN_CALLBACK);

...
class ENGINE_API MulticastDelegateBase
{
public:
	/// Constructor
	MulticastDelegateBase() : m_invocationHead(0) {}
    MulticastDelegateBase(MulticastDelegateBase&& Other) = default;
	MulticastDelegateBase& operator =(MulticastDelegateBase&& Other) = default;

...
/// must always be used.
class ENGINE_API MulticastDelegate0 : public MulticastDelegateBase
{
public:
	MulticastDelegate0() { }
	MulticastDelegate0(MulticastDelegate0&& Other) = default;
	MulticastDelegate0& operator =(MulticastDelegate0&& Other) = default;
...
public:
    MulticastDelegate1() { }
    MulticastDelegate1(MulticastDelegate1&& Other) = default;
    MulticastDelegate1& operator =(MulticastDelegate1&& Other) = default;
...
public:
	MulticastDelegate2() { }
    MulticastDelegate2(MulticastDelegate2&& Other) = default;
    MulticastDelegate2& operator =(MulticastDelegate2&& Other) = default;
...
public:
    MulticastDelegate3() { }
    MulticastDelegate3(MulticastDelegate3&& Other) = default;
    MulticastDelegate3& operator =(MulticastDelegate3&& Other) = default;
